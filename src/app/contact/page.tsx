        ...
        <div>
            ...
            <div className="xl:hidden flex flex-col gap-4 items-center justify-center">
                ...
                <RectangularButton
                    ...
                    styling="text-[2vh] text-white"
                />
                <div className="bg-[var(--muted)] h-full w-full rounded-[5rem] p-10">
                    <form onSubmit={handleSubmit} className="text-[var(--primary)]">
                        <input
                            type="text"
                            name="name"
                            ...
                            onChange={handleChange}
                            required
                            className="w-full h-[4vh] rounded-lg px-3 bg-[var(--muted)] text-[var(--foreground)] border border-[var(--primary)]"
                        />
                        <input
                            type="email"
                            name="email"
