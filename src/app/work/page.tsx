        ...
        <div>
            ...
            <div className="xl:hidden">
                <div className="flex flex-col items-center">
                    <h1 className="text-[8vw] text-center">
                        Harrison Blair
                    </h1>
                    <div className="relative w-full aspect-square m-2 mx-auto">
                        <Image
                            src="/images/Harrison-Blair.png"
                            alt="Profile Picture"
                            fill
                    ...
                    <div className="bg-[var(--muted)] rounded-[2.5rem] mt-4 p-4">
                    ...
                    <div className="bg-[var(--muted)] rounded-[2.5rem] mt-2 p-4">
                        <div className="flex flex-col m-4 gap-2">
                            <h2 className="text-[3vh] text-[var(--primary)]">
                                Skills
                            </h2>
